...
const PARAMETER_PRIORITY: Record<string, string[]> = {
  ...
  call_scenario: ["path"],
  click_image: ["images", "click_type", "position", "region", "region_origin", "target_window_title", "retry"],
  concat_variable: ["name", "value"],
  copy_file: ["path", "destination"],
  get_excel_value: ["name", "cell", "path"],
  if: ["variable", "equals", "last_step"],
  launch_app: ["path", "wait_for_window", "startup_timeout_ms"],
  load_table: ["name", "path", "sheet"],
  move_file: ["path", "destination"],
  move_mouse_to_image: ["images", "position", "region", "region_origin", "target_window_title", "retry"],
  paste_variable: ["name"],
  repeat: ["path", "count"],
  set_clipboard: ["text"],
